...
require('lazy').setup({
  ...
  -- "gc" to comment visual regions/lines
  {
    ...
    opts = {},
    dependencies = {
      -- This is a plugin that integrates Comment.nvim with treesitter
      -- This allows for proper commentstring detection the filetypes
      -- with embedded languages like jsx, vue, etc.
