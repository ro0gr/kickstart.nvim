return {
  ...
  config = function()
    ...
    local servers = {
      ...
      -- TODO: fix root markers for deno. Currently it gets enabled on .git existence which is not correct
      -- denols = {
      --   root_dir = require('lspconfig').util.root_pattern('deno.json', 'deno.jsonc'),
      --   root_markers = require('lspconfig').util.root_pattern('deno.json', 'deno.jsonc'),
      -- },
      lua_ls = {
        -- cmd = { ... },
        -- filetypes = { ... },
